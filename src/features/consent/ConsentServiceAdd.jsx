...
class ConsentAddService extends React.Component {
    ...
    showAddServiceDialog = () => {
        this.setState({
            serviceAddIsOpen: true,
        });
    };

    hideAddServiceDialog = () => {
        this.setState({
            serviceAddIsOpen: false,
        });
    };
    ...
    addNewServiceDialog = () => {
        ...
        this.props.addNewService(this.state.serviceName);
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Dialog open={this.state.serviceAddIsOpen} onClose={this.hideAddServiceDialog} aria-labelledby="form-dialog-title">
                    ...
                    <DialogActions>
                        ...
                        <Button onClick={this.addNewServiceDialog} color="primary">
                            Add
                        </Button>
                    </DialogActions>
                </Dialog>

                <Dialog open={this.state.policyAddIsOpen} onClose={this.hideAddPolicyDialog} aria-labelledby="form-dialog-title">
                    <DialogTitle id="form-dialog-title">Behandlingsgrunnlag</DialogTitle>
                    <DialogContent>
                        <DialogContentText>
                            information about adding a new legal reason for the right to ask for such info.
                        </DialogContentText>
                        <FormControl className={classes.inputForm} id={"serviceFormControl"}>
                            <TextField
                                autoFocus

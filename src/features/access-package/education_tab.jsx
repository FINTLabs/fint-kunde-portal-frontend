        ...
        <div>
            <AppBar position="static">
                <Tabs value={secondaryTabValue} onChange={handleSecondaryTabChange} aria-label="simple tabs example">
                    ...
                    <Tab label="Elev" {...a11yProps(1)} />
                    <Tab label="Kodeverk" {...a11yProps(2)} />
                    <Tab label="Timeplan" {...a11yProps(3)} />
                    <Tab label="Utdanningsprogram" {...a11yProps(4)} />
                    <Tab label="Vurdering" {...a11yProps(5)} />
                    <Tab label="Vigo Kodeverk" {...a11yProps(6)} />
                </Tabs>
            </AppBar>

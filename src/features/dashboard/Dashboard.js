                ...
                <div className={classes.root}>
                    <Grid container spacing={24}>
                        <Grid item xs={12}>
                            <FeatureHelperText>
                                <p>
                                    FINT kundeportal skal benyttes av fylkeskommuner og andre organisasjoner som
                                    benytter FINT til å gi
                                    tilgang til egne data.
                                </p>
                                <p>
                                    Kundeportalen skal gi personer som har fått tildelt roller i en organisasjon
                                    mulighet for å
                                    administrere
